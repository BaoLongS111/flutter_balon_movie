import 'package:balon_movie/common/utils/common_util.dart';
import 'package:balon_movie/common/utils/screen_adaper.dart';
import 'package:balon_movie/common/utils/time_util.dart';
import 'package:balon_movie/common/utils/widget_util.dart';
import 'package:balon_movie/pages/full_video_page.dart';
import 'package:balon_movie/widget/tencent_player/tencent_player_linear_progress_indicator.dart';
import 'package:balon_movie/widget/tencent_player/triangle_painter.dart';
                ...
                children: <Widget>[
                    ...
                    child: Container(
                      ...
                      child: Image.asset(
                        controller.value.isPlaying
                            ? 'assets/images/tencentplayer/player_pause.png'
                            : 'assets/images/tencentplayer/player_play.png',
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      setState(() {
                        widget.controller = newController;
                      });
                    },
                    child: widget.isShow && widget.showFullScreen
                        ? Container(
                            padding: EdgeInsets.fromLTRB(
                                ...
                                ScreenAdaper.setWidth(30)),
                            child: Image.asset(
                              'assets/images/tencentplayer/full_screen_on.png',
                              width: ScreenAdaper.setWidth(50),
                              height: ScreenAdaper.setWidth(50),
                            ),
                          )
                        : SizedBox(),
                  )
